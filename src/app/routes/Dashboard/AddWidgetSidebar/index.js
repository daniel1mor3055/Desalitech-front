...
import myImage from 'app/routes/SystemsAndLiveAlarms/assets/large_no_background_top.svg'

import SideNavOption from 'containers/Customizer/SideNavOption';
import {changeDirection, setDarkTheme, setThemeColor} from 'store/actions/Setting';
import {
  AMBER,
  BLUE,
  CYAN,
...
class AddWidgetSidebar extends Component {
...
export default withRouter(connect(mapStateToProps, {setThemeColor, setDarkTheme, changeDirection})(AddWidgetSidebar));
